...
var OAuthIOStart=function(){var d={done:function(a,b){if(b.status&&"success"===b.status){var c=new XMLHttpRequest,e=this;c.onerror=function(b){e.error(a,b.responseText)};c.onreadystatechange=function(d){4===c.readyState&&(200===c.status?e.success(a,b):e.error(a,d.responseText))};c.open("POST",url);c.send(JSON.stringify(b.data))}},fail:function(a,b){console.error(this.error(a,b))},success:function(a,b){document.location=document.location},error:function(a,b){console.error("For provider:"+a+"Error: "+ b)}};return function(a){if(void 0===a.public_key)!0===a.debug&&alert("OAuth.io public key is not set");else{for(var b in a)d[b]=a[b];OAuth.initialize(a.public_key);a=document.querySelectorAll("[data-oauthio-provider]");for(var c in a)(function(a){"object"===typeof a&&(a.onclick=function(b){b.preventDefault();var c=a.getAttribute("data-oauthio-provider");OAuth.popup(c).done(function(a){a.me().done(function(a){d.done(c,a)}).fail(function(a){d.fail(c,a)})}).fail(function(a){d.fail(c,a)})})})(a[c])}}}();
